...
from src.assertions.get_cases_assertions import assert_get_cases_assertion, assert_get_cases_response_schema, assert_response_status_code, assert_entities_field_equal, cases_get_headers, cases_get_url

@pytest.mark.somke
@pytest.mark.funtional
@pytest.mark.regression
def test_DR_TC01_Verificar_la_obtencion_de_todos_los_casos_de_prueba_de_un_proyecto (get_url, get_token):
    response = assert_get_cases_assertion("GET", cases_get_url(get_url, "DEMO"), cases_get_headers(get_token))
    log_api_call(method="GET",
        url=cases_get_url(get_url, "DEMO"),
        headers=cases_get_headers(get_token),
        payload=None,
        token=get_token,
        response=response
    )
...
def test_DR_TC03_Verificar_que_retorna_una_respuesta_401_al_obtener_todos_los_casos_de_prueba_de_un_proyecto_cuando_no_tiene_un_token_valido (get_url):
    response = assert_get_cases_assertion("GET", cases_get_url(get_url, "DEMO"),cases_get_headers("invalido"))
    log_api_call(method="GET",
                 url=cases_get_url(get_url, "DEMO"),
                 headers=cases_get_headers("invalido"),
                 payload=None,
                 token="invalido",
                 response=response
                 )
...
def test_DR_TC04_Verificar_que_retorna_una_respuesta_404_al_obtener_todos_los_casos_de_prueba_de_un_proyecto_que_no_existe (get_url, get_token):
    response = assert_get_cases_assertion("GET", cases_get_url(get_url, "proyectoquenoexiste"), cases_get_headers(get_token))
    log_api_call(method="GET",
...
def test_DR_TC05_Verificar_que_retorna_una_respuesta_400_al_obtener_todos_los_casos_de_prueba_con_el_método_POST (get_url, get_token):
    response = assert_get_cases_assertion("POST", cases_get_url(get_url, "DEMO"), cases_get_headers(get_token))
...
def test_DR_TC06_Verificar_que_retorna_una_respuesta_405_al_obtener_todos_los_casos_de_prueba_con_el_método_PUT (get_url, get_token):
    response = assert_get_cases_assertion("PUT", cases_get_url(get_url, "DEMO"), cases_get_headers(get_token))
...
def test_DR_TC07_Verificar_que_retorna_una_respuesta_405_al_obtener_todos_los_casos_de_prueba_con_el_método_DELETE (get_url, get_token):
    response = assert_get_cases_assertion("DELETE", cases_get_url(get_url, "DEMO"), cases_get_headers(get_token))
