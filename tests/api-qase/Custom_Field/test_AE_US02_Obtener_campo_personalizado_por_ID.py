...
from src.assertions.get_custom_field_assertions import assert_get_custom_field_response_schema,assert_response_status_code_custom_field
...
def test_AE_TC021_Obtener_un_campo_personalizado_por_ID_valido (get_url):
    ...
    assert_get_custom_field_response_schema(response.json(),"schema_salida_valido")
...
def test_AE_TC022_Obtener_un_campo_personalizado_por_ID_vacio(get_url):
    ...
    assert_response_status_code_custom_field(400, response.status_code)
