...
def test_004_Verificar_error_404_al_acceder_a_endpoint_inexistente():
    # Descripción: Verificar que el API responde con un código 404 al acceder a un recurso que no existe.
    url = "https://collectionapi.metmuseum.org/public/collection/v1/departamentoss"
    headers = {
